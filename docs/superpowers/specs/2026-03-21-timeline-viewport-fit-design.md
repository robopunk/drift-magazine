...
Replace the hardcoded `CANVAS_HEIGHT = 480` with a dynamic height derived from `calc(100vh - 120px)`.
...
| File | Changes |
|---|---|
| `TimelineCanvas.tsx` | Dynamic height via `calc(100vh-120px)`, derive canvas dimensions from measured height |
